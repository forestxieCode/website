...
// 酒店订单
export function getHotelList(prate) {
  return axios.get(originApi + '/auth/website/getHotelList?pageNumber='+prate.pageNumber+'&pageSize='+prate.pageSize)
}
export function deleteHotel(id) {
  return axios.get(originApi + '/auth/website/deleteHotel?id='+id)
}
// http://192.168.0.187:8085/auth/website/deleteHotel 
