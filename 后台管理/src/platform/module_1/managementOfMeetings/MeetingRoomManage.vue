<template>
  <div id="WalkIntoXilin">
    ...
    <el-row class="padd" :gutter="4" :span="24">
        ...
        <el-col :span="2" >
            <el-input v-model="parameter.title" placeholder="会议室名称" size="small"></el-input>
        </el-col>
        <el-col :span="2" >
...
export default {
  ...
  methods: {
    ...
    go_to_add(){
      this.$router.push({path:'/Home/AddWalkIntoInfo',query:{type:6}});
    },
    go_to_eidt(id){
      this.$router.push({path:'/Home/AddWalkIntoInfo',query:{id:id,type:6}});
    },
