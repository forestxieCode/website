        ...
        <el-col :span="24" >
             <el-table v-loading="loading" :data="tableData" :row-style="HeightClass"  :row-class-name="tableRowClassName" border style="width: 100%">
                   <el-table-column
                    ...
                    >
                          <template slot-scope="scope">
                            {{new Date(scope.row.inTime).Format('yyyy-MM-dd')}}
                          </template>
                    </el-table-column>
                    <el-table-column
                          align="center"
                    ...
                    >
                          <template slot-scope="scope">
                            {{new Date(scope.row.outTime).Format('yyyy-MM-dd')}}
                          </template>
                    </el-table-column>
                      <el-table-column
                          align="center"
...
<script>
import { getMeetingList , deleteMeeting } from './api/index'
...
export default {
  ...
  methods: {
    ...
    getList(){
      ...
      getMeetingList(this.parameter).then(res =>{
        if(res.success){
          this.value6=''
