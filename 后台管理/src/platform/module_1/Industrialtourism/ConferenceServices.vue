<template>
  <div id="Banner">
    ...
    <el-row  :gutter="10" class="content">
            <el-col :span="6" v-for="item in CarousesData" :key="item.id">
              <div class="item">
                ...
                <div class="overhold">
                    <span class="el-icon-zoom-in" @click="showimg(item)"></span>
    ...
    <el-dialog
      ...
      width="30%"
      >
      <el-form :model="frompropo"  ref="fromUpload"  :rules="funcFormRuleList" label-width="100px">
          <el-col :span="24">
          ...
          <el-col :span="24">
              <el-form-item label="会议室类型" prop="title">
                <el-input v-model="frompropo.title" size="small" ></el-input>
              </el-form-item>
          </el-col>
          <el-col :span="24">
              <el-form-item label="会议室信息" prop="remark">
                <el-input type="textarea" v-model="frompropo.remark" size="small" :row="3"></el-input>
              </el-form-item>
          </el-col>
          <el-col :span="24">
      ...
      <el-row>
         <el-col :span="24">
            <img :src="roominfo.picPath" alt="" style="width:100%;height:100%;">
        </el-col> 
        <el-col :span="24" style="margin-top:20px;">
             <span  style="font-size:20px;color:#333;">会议室类型:</span>{{roominfo.title}}
        </el-col> 
         <el-col :span="24" style="margin-top:10px;">
           <span  style="font-size:20px;color:#333;">会议室信息:</span>{{roominfo.remark}}
        </el-col>
      </el-row>
      <span slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    beforeAvatarUpload(file) {
        ...
        if (!isLt2M) return this.$message.error("上传图片大小不能超过 5MB!");
        return isLt2M;
    },
    getCarouses(){
      getCarouses(4).then(res =>{
        if(res.success){
