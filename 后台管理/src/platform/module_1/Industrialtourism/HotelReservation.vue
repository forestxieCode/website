  ...
  <div id="Banner">
    ...
    <el-dialog
      ...
      <el-form :model="frompropo"  ref="fromUpload"  :rules="funcFormRuleList" label-width="80px">
          ...
          <el-col :span="24">
              <el-form-item label="房间信息" prop="remark">
      ...
      <el-row>
        ...
        <el-col :span="24" style="margin-top:20px;">
             <span  style="font-size:20px;color:#333;">房间类型:</span>{{roominfo.title}}
        </el-col> 
         <el-col :span="24" style="margin-top:10px;">
           <span  style="font-size:20px;color:#333;">房间信息:</span>{{roominfo.remark}}
        </el-col>
      </el-row>
      <span slot="footer" class="dialog-footer">
